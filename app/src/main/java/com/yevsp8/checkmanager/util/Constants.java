...
public class Constants {
    ...
    public static double Check_PaidTo_Top_DistFrom_Top = 8.48 / height;
    ...
    public static double Check_ID_Left_DistFrom_Left = 0.4 / width;
    public static double Check_ID_Right_DistFrom_Left = 5.8 / width;
    public static double Check_PaidTo_Left_DistFrom_Left = 0.2 / width;
    public static double Check_PaidTo_Right_DistFrom_Left = 5.8 / width;
}
