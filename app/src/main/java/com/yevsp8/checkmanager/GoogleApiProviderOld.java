...
public class GoogleApiProviderOld implements EasyPermissions.PermissionCallbacks {
    ...
    private static GoogleApiProviderOld provider;
    String mOutputText;
    ...
    private GoogleApiProviderOld(final MainActivity activity) {
    ...
    public static GoogleApiProviderOld getInstance(final MainActivity activity) {
        if (provider == null)
            provider = new GoogleApiProviderOld(activity);
        return provider;
    }
